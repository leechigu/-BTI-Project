...
public class mbti_job_info_popup extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if(jobName.equals("승무원")){
            String crew = " 항공기 승무원의 특징은 협력, 책임감, 배려심입니다. 누구에게나 밝게 웃어 줄 수 있는 "+mbti+"의 여러분들은 다른 이들과 협력하고자 하는 강한 마음을 가지고 있습니다. 또한 승객을 목적지 까지 안전하게 대려다 주겠다는 강한 책임감을 가지며, 항상 다른이들을 배려하는 마음을 보유하고 있기 때문에 “승무원”이라는 직업을 추천드립니다.";
            jobInfoText.setText(crew);
        }

        else if(jobName.equals("판사")){
            String judge = " 판사의 특징은 리더쉽 판단력 준법입니다. 항상 정의로움을 추구하는 "+mbti+"의 여러분들은 판결을 이끌어 갈 수 있는 리더쉽이 있고, 억울한 사람이 없도록 할 수 있는 판단력을 보유하고 있습니다. 또한 높은 기억력으로 판사의 역량을 충족시킬 수 있고 옳은 판결을 할 판단력을 가지고 있기 때문에 “판사”라는 직업을 추천 드립니다.";
            jobInfoText.setText(judge);
        }
